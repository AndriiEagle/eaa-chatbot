...
export function convertDescriptiveToQuestion(text: string): string {
  ...
  const patterns = [
    ...
    [
      'я украинская транспортная компания',
      'Какие требования к доступности веб-сайта для украинской транспортной компании?',
    ],
    [
      'транспортная компания',
      'Какие требования к доступности веб-сайта транспортной компании согласно European Accessibility Act?',
    ],
    [
      'компания грузоперевозки',
      'Как European Accessibility Act применяется к компаниям, занимающимся грузоперевозками?',
    ],
    [
      'пассажирские перевозки',
      'Каким требованиям доступности должны соответствовать сервисы пассажирских перевозок согласно European Accessibility Act?',
    ],

    // Разные типы бизнеса
    [
      'я компания',
      'Какие требования к доступности веб-сайта для компаний согласно European Accessibility Act?',
    ],
    [
      'у меня бизнес',
      'Какие требования European Accessibility Act применяются к моему бизнесу?',
    ],
    [
      'интернет-магазин',
      'Какие требования к доступности интернет-магазина согласно European Accessibility Act?',
    ],
    [
      'онлайн-торговля',
      'Какие требования к онлайн-торговле устанавливает European Accessibility Act?',
    ],
    [
      'банк',
      'Какие требования к доступности банковских цифровых сервисов согласно European Accessibility Act?',
    ],
    [
      'туристическое агентство',
      'Какие требования к туристическим агентствам устанавливает European Accessibility Act?',
    ],
    ...
    [
      'продаю билеты',
      'Какие требования к доступности веб-сайта для продажи билетов согласно European Accessibility Act?',
    ],
    [
      'продаю онлайн',
      'Какие требования к онлайн-продажам устанавливает European Accessibility Act?',
    ],
    [
      'оказываю услуги',
      'Какие требования к доступности при оказании услуг устанавливает European Accessibility Act?',
    ],

    // Web и мобильные приложения
    [
      'сайт доступным',
      'Как сделать сайт доступным согласно European Accessibility Act?',
    ],
    [
      'мобильное приложение',
      'Какие требования к доступности мобильных приложений устанавливает European Accessibility Act?',
    ],
    [
      'веб-приложение',
      'Какие требования к доступности веб-приложений согласно European Accessibility Act?',
    ],

    // Общие запросы
    [
      'нужно',
      'Что нужно сделать для соответствия требованиям European Accessibility Act?',
    ],
    [
      'надо',
      'Что надо сделать для соответствия требованиям European Accessibility Act?',
    ],
    [
      'требования',
      'Какие требования European Accessibility Act применимы в данном случае?',
    ],
    [
      'обязательно ли',
      'Обязательно ли соблюдать требования European Accessibility Act в данном случае?',
    ],
    [
      'штрафы',
      'Какие штрафы грозят за несоблюдение European Accessibility Act?',
    ],
  ...
  for (const [pattern, question] of patterns) {
    if (lower.includes(pattern)) {
      console.log(
        `🔄 [TRANSFORM] Преобразую описательный запрос "${text}" в вопрос: "${question}"`
      );
      return question;
    }
  }
...
`,
  ...
  try {
    ...
    try {
      ...
      console.log(
        `✅ [PREPROCESS] Результат классификации: ${result.isRelevant ? 'РЕЛЕВАНТЕН' : 'НЕ РЕЛЕВАНТЕН'}`
      );
      if (result.isRelevant && result.reformulatedQuery) {
        console.log(
          `✅ [PREPROCESS] Улучшенный запрос: "${result.reformulatedQuery}"`
        );
      }
      if (result.needMoreInfo) {
        console.log(
          `✅ [PREPROCESS] Требуется уточнение. Вопросы: ${result.clarificationQuestions?.join(', ')}`
        );
      }
      ...
      if (result.isRelevant) {
        ...
        console.log(
          `⏱ [SPLIT] Time: ${Math.round(performance.now() - splitTimer)}ms`
        );
      ...
      console.error(
        '❌ [PREPROCESS] Error parsing JSON from model response:',
        e
      );
