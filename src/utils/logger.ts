...
class Logger {
  ...
  aiOperation(operation: string, model: string, context?: Record<string, any>): void {
  ...
  databaseOperation(operation: string, table: string, context?: Record<string, any>): void {
...
export const logApiCall = (endpoint: string, method: string, duration?: number, statusCode?: number) => {
...
export const logBusinessEvent = (event: string, userId?: string, sessionId?: string, data?: Record<string, any>) => {
