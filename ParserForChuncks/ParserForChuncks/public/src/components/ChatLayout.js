 ...
 */
const ChatLayout = ({ messages, loading, onSendMessage, onCopy, onSelectSuggestion, onSuggestionContextUpdated, messageSentTrigger, loaderPhrase, input, setInput, userId, sessionId, isProactiveAgentEnabled }) => {
    ...
    return (_jsxs(Rnd, { size: size, position: position, onDragStop: (e, d) => {
        ...
        }, minWidth: 400, minHeight: 500, bounds: "window", dragHandleClassName: "drag-handle", style: {
            background: '#23272A',
            borderRadius: '1rem',
            ...
            flexDirection: 'column',
        }, children: [_jsx("div", { className: "drag-handle", style: {
                    position: 'absolute',
                    top: 0,
                    left: 0,
                    ...
                    cursor: 'move',
                    zIndex: 1
                } }), _jsx("button", { onClick: handleSaveLayout, style: {
                    position: 'absolute',
                    top: '10px',
                    right: '10px',
                    zIndex: 2,
                    ...
                    borderRadius: '5px',
                    cursor: 'pointer'
                }, children: "Save" }), _jsxs("div", { ref: chatRef, style: {
                    flex: 1,
                    overflowY: 'auto',
                    padding: '1.5rem',
                    ...
                    gap: '1rem',
                            ...
                            justifyContent: msg.role === 'user' ? 'flex-end' : 'flex-start',
                        }, children: [msg.role === 'bot' && (_jsx("div", { style: {
                                    width: '2rem',
                                    height: '2rem',
                                    borderRadius: '50%',
                                    background: '#4b5563',
                                ...
                                }, children: _jsx("img", { src: "/bot_avatar.png", alt: "Bot", style: {
                                        width: '100%',
                                        height: '100%',
                                        borderRadius: '50%',
                                        objectFit: 'cover'
                    ...
                    gap: '1rem',
                    background: '#202225'
                }, children: [_jsx("div", { style: { flex: 1 }, children: _jsx(ChatInput, { onSendMessage: onSendMessage, loading: loading, input: input, setInput: setInput }) }), _jsx(WhisperInput, { onTranscriptReceived: (transcript) => {
                            setInput(prevInput => `${prevInput}${prevInput ? ' ' : ''}${transcript}`);
                        }, disabled: loading, userId: userId, sessionId: sessionId, currentInput: input, isProactiveAgentEnabled: isProactiveAgentEnabled, onSuggestionContextUpdated: onSuggestionContextUpdated, messageSentTrigger: messageSentTrigger })] })] }));
};
