...
import {
  SuggestionService,
  SuggestionRequest,
} from '../services/suggestionService/suggestion.service.js';
 ...
 */
export const generateModernSuggestions = async (
  req: Request,
  res: Response
) => {
  ...
  try {
    ...
    const result =
      await suggestionService.generateRevolutionarySuggestions(request);
 ...
 */
export const generateFallbackSuggestions = async (
  req: Request,
  res: Response
) => {
