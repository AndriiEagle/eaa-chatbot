 ...
 */
export async function findRelevantChunks(queryEmbedding, datasetId, similarityThreshold, matchCount) {
 ...
 */
export async function logQuery(question, translatedQuestion, answer, datasetId, matchedChunkIds, id) {
    try {
